...
import com.eighteengray.procameralibrary.util.SharePreferenceUtils;
...
//                            aeState = result.get(CaptureResult.CONTROL_AE_STATE);
    ...
    private void judgeFocus() {
        if (mAfState == CameraMetadata.CONTROL_AF_STATE_INACTIVE) {
        ...
        } else if (mAfState == CameraMetadata.CONTROL_AF_STATE_PASSIVE_SCAN) {
        ...
        } else if (mAfState == CameraMetadata.CONTROL_AF_STATE_PASSIVE_FOCUSED) {
        ...
        } else if (mAfState == CameraMetadata.CONTROL_AF_STATE_ACTIVE_SCAN) {
        ...
        } else if (mAfState == CameraMetadata.CONTROL_AF_STATE_PASSIVE_UNFOCUSED) {
